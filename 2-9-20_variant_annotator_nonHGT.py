...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  2 14:09:48 2020
...
#for pop in ['T1CLR']:
    ...
    mauve_SNPs='/Users/lwoo0005/Documents/An_H_pylori/mauve_snps_n_gaps/Mauve_P12_v_maxHGTs/Mauve_P12_428_frxA_from_MCE2_SNPs'
    ...
    #mauve_gaps = '/Users/lwoo0005/Documents/An_H_pylori/mauve_snps_n_gaps/Mauve_P12_'+pop_in_fasta+'_misc_gaps'
    #mauve_gaps='/Users/lwoo0005/ab_mauve_maxHGTs/Mauve_P12_ShamiFA_MCE3T0_maxHGT_gaps'
    #Open the BAM file
    #/Users/lwoo0005/Documents/An_H_pylori/evolved_strains/bam_data/426A1_vs_P12_w_HPP12_w_426A1_maxHGT_genome_breseq_p0_bam_info
    #/Users/lwoo0005/Documents/An_H_pylori/rdxA_frxA_HGT_search/no_Mtz_428_frxA_rdxA_HGT_search_bam_data/428F1_vs_P12_w_HPP12_MCE2_maxHGT_genome_breseq_p0_bam_info/428F1_vs_P12_w_HPP12_MCE2_maxHGT_genome_breseq_p0_alignment.bam
    ...
    #/Users/lwoo0005/Documents/An_H_pylori/Clr_Crtl_Fitness_assay/v_P12_bam_data/426F4T0_L3_breseq_v_P12_only_p0_bam_info
    ...
    gb_inp=''
    #real_counts_file='/Users/lwoo0005/Documents/An_H_pylori/Clr_Crtl_Fitness_assay/misc_variation/All_'+pop+'_breseq_v_P12_w_HPP12_p0_misc_variation_on_P12_as_counts.csv'
    real_counts_file='/Users/lwoo0005/Documents/An_H_pylori/All_'+pop+'_428_frxA_HGT_from_MCE2_on_P12_as_counts.csv'
    #Output location for the resultant vcf file
    gd_op_path='/Users/lwoo0005/Documents/An_H_pylori/All_'+pop+'_428_frxA_HGT_from_MCE2_on_P12.gd'
    #gd_op_path='/Users/lwoo0005/Documents/An_H_pylori/Clr_Crtl_Fitness_assay/misc_variation/All_'+pop+'_breseq_v_P12_w_HPP12_p0_misc_variation_on_P12.gd'
    #gd_op_path='/Users/lwoo0005/Documents/Laura_stuff/H_py_An/Clr_Ctrl_fitness_assays/All_'+pop+'T0_breseq_v_P12_w_HPP12_p0_HGT_events_on_P12.gd'
    ...
    #rec = [rec for rec in SeqIO.parse(fasta_file, "fasta")][0]
    #all_recs.append(rec.id)
    recs = [rec for rec in SeqIO.parse(fasta_file, "fasta")]
    all_recs=[rec.id for rec in recs]
    for gap in gaps:
        gap_cols=gap.split('\t')
    ...
    for refer in sam_cov_a:
        refer_cov.append(int(refer[0]))
        HGT_cov.append(int(refer[1]))
        total_cov.append(int(refer[0])+int(refer[1]))
        if int(refer[0])+int(refer[1]) == 0:
    ...
    for HGT,refer,total in zip(HGT_cov, refer_cov, total_cov):
        if total==0:
            print("Here")
            print(n)
            HGT_freq.append("No coverage")
            ref_freq.append("No coverage")
        else:
